      ...
      <p className="text-2xl text-green font-bold relative top-3 text-center">
        ...
        <div className="font-bold flex p-4 h-[29rem] al:h-[32rem] lg:h-[40rem] 2lg:h-[50rem] text-md sl:text-xl bg-white rounded-lg justify-around mt-10 ">
          ...
          <div>
            ...
            <div>
              <p className="  text-slate-500 ">Group Sange</p>
              <p className=" pt-4">{id.nom} nom</p>
            </div>
          </div>
        </div>
      ...
      </>}
      {
        ...
        <form className="flex p-4 h-[29rem] al:h-[32rem] lg:h-[40rem] 2lg:h-[50rem] xl:h-[60rem] text-md 2lg:text-xl bg-white rounded-lg justify-around mt-10 text-lg ">
          <div className="flex flex-col gap-10 w-1/2 py-6 ">
            ...
            <div className="flex mt-8 gap-8 al:mt-12 lg:mt-48 2lg:mt-80 xl:mt-96">
                <button type="submit" className="  bg-green rounded-sm text-white font-semibold w-1/4 hover:shadow-green">Enregistrer</button> 
                <button className=" p-2 bg-gray-light rounded-sm text-green font-semibold w-1/4 hover:shadow-custom-black">Supprimer</button>
          ...
          <div className="flex justify-start ">
            ...
            <div className="flex justify-start">
              <p className="  text-green font-semibold  items-center flex w-44">Groupe sanguin</p>
              <select required className=" rounded-sm bg-slate-100 p-2 outline-green">
            ...
            <button className=" p-2 bg-green rounded-sm text-white font-semibold w-1/4 hover:shadow-custom-black" onClick={retourGP}>Retour</button>
            </div>
          </div>
        </form>
        </>
        ...
        <form className="flex p-4 h-[29rem] al:h-[32rem] lg:h-[40rem] 2lg:h-[50rem] xl:h-[60rem] text-md 2lg:text-xl bg-white rounded-lg justify-around mt-10 text-lg">
          <div className="flex flex-col gap-10 w-1/2 py-6 ">
            ...
            <div className="flex justify-start">
              <p className="  text-green font-semibold items-center flex w-28">Email</p>
              <input required type="email" name="" id="" className="rounded-sm bg-slate-100 p-2 outline-green" />
            </div>
