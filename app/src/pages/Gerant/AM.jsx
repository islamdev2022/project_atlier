...
const handleSubmit = (event) => {
  ...
  <form className="flex mt-4 p-4 h-[25rem] al:h-[32rem] lg:h-[40rem] 2lg:h-[50rem] xl:h-[60rem] bg-zinc-200 rounded-lg justify-around" onSubmit={handleSubmit} onReset={handleReset}>
    ...
    <option value="Femme">Femme</option>
            ...
            {option==="Ajouter" &&<button type="submit" className=" p-2 bg-green rounded-sm text-white font-bold w-1/3 hover:shadow-green" id="ajoute" >Ajouter</button> }
                {option==="Modifier" && <button type="submit" id="edit" className=" p-2 bg-green rounded-sm text-white font-bold w-1/3 hover:shadow-green" >Modifier</button> }

                {option==="Ajouter" &&<button type="reset" className=" p-2 bg-white rounded-sm text-green font-bold w-1/3 hover:shadow-custom-black">Anuller</button>}
            </div>
    ...
    <input required className="border p-2 mr-2 rounded-md w-4/5 flex justify-start" type="text" placeholder="Prénom" name="prenom" id='pr' onChange={handleChange}/>
        ...
        <div>
            <label htmlFor="text" className="flex ">Nom Utilisateur</label>
    ...
    <div>
        <label htmlFor="text" className="flex" >Role</label>
    <select required className="border p-2 rounded-md flex cursor-pointer" name="spec" id='rl' >
        ...
        <label htmlFor="text" className="flex">QR Code</label>
         <div className="flex">
            ...
            <div className="flex gap-10 mt-24">
                {option==="Ajouter" && <button type="submit" className=" p-2 bg-green rounded-sm text-white font-bold w-1/3 mt-32 hover:shadow-green" >Ajouter</button> }
                {option==="Modifier" && <button type="submit" className=" p-2 bg-green rounded-sm text-white font-bold w-1/3 mt-32 hover:shadow-green">Modifier</button> }

                {option==="Ajouter"&&<button type="reset" className=" p-2 bg-white rounded-sm text-green font-bold w-1/3 mt-32 hover:shadow-custom-black">Anuller</button>}
            </div>
