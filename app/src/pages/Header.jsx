...
const Header = ({user ,choice}) => {//possible an attribute to define where the header is used for search option
  ...
  const handleContinue = () => {
    ...
    <img src="/assets/notification copy (1).png" alt="notification" className='size-8 mt-1 ml-[30px] cursor-pointer' onClick={toggleNotifications} />
    {isOpen && (
        <div ref={notificationRef} className="absolute top-20 right-24 rounded-lg w-52 h-40 bg-white z-10 p-2">
